...
class DisplayArticles extends Component {
  ...
  async getArticles() {
    try {
      ...
      if (error.response) {
        console.log(
          "Server has responded to request from client with an error message"
        );
        ...
        console.log(
          "No response is received by client after request to server"
        );
        console.log(error.request);
      } else {
        console.log(
          "The client request to the server has a configuration error"
        );
